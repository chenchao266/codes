...
int getAllMergeTransParam(const GeneralPermutation& permut, const GeneralComponent& comps, vector<TransParam>& trsprms)
{
	...
	list<GeneralChromTree::ChromTreeNode*>::const_iterator cctitor1,cctitor2,cctitor11e;
	vector<GeneralInterval>::const_iterator cpitor1,cpitor2;
	//int i,j;
	int chi, chj;
